package com.syscloud.provider.user.job;

import com.syscloud.provider.user.config.KeyConfiguration;
import com.syscloud.utils.jwt.RsaKeyHelper;
 ...
 */
@Configuration
public class AuthServerJob implements CommandLineRunner {
    @Autowired
    private RedisTemplate<String, String> redisTemplate;
    private static final String REDIS_USER_PRI_KEY = "HMST:AUTH:JWT:PRI";
    private static final String REDIS_USER_PUB_KEY = "HMST:AUTH:JWT:PUB";
    private static final String REDIS_SERVICE_PRI_KEY = "HMST:AUTH:CLIENT:PRI";
    private static final String REDIS_SERVICE_PUB_KEY = "HMST:AUTH:CLIENT:PUB";
