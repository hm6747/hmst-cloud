...
@AutoConfigureBefore({AdminServerNotifierAutoConfiguration.SlackNotifierConfiguration.class,AdminServerNotifierAutoConfiguration.CompositeNotifierConfiguration.class})
